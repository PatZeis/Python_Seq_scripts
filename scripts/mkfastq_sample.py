...
parser.add_argument("-m", "--multiomic_layer", help="give_multiomic_layer", type=str)
...
if rna | atac:
    ...
    if len(flow_cell_names) == 1:
        ...
        for s, f, l,  i in zip(samples, flow_cells, lanes,index):
            ...
            l =  ",".join(list(l))
            sample_id =  [s,f,flow_cell_names, l, i, index2,layer]
            d[s] = sample_id
        ...
        for s, f, n,l, i in zip(samples, flow_cells, flow_cell_names, lanes, index ):
            ...
            l =  ",".join(list(l))
            sample_id =  [s,f,n, l, i, index2, layer]
            d[s] = sample_id
    
    
    data = pd.DataFrame.from_dict(d, orient='index', columns=["id","flowcell_number","flowcell_name","lane_numbers","index", "index2", "layer"])
